...
\begin{tcolorbox}[left=2cm, right=2cm]
\blindtext
\end{tcolorbox}
...
\tcbox[center,
    ...
    title={Eingerückte Box},
    fontupper=\bfseries,
    left=2cm,
    right=2cm
]{
    Hier steht der Inhalt der eingerückten Box.
}
...
\begin{tcolorbox}[colback=green!5!white,colframe=red!75!black,title=My nice heading]
...
in this example, prefixed with the section number. This theorem is numbered with \ref{th:theoexample}, it is given on page~\pageref{th:theoexample}.
\end{mytheo}
